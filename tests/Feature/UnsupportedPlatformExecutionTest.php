...
it('fails install replicate status and restore when litestream is disabled', function (): void {
    Process::fake([
    ...
    foreach (['litestream:install', 'litestream:replicate', 'litestream:status', 'litestream:restore'] as $command) {
